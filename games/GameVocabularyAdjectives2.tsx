...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; user-select: none; -webkit-tap-highlight-color: transparent; }
        ...
        .popup-img-small { width: 120px; height: 120px; object-fit: contain; background: white; border-radius: 15px; flex-shrink: 0; }
...
<body>
    ...
    <script>
        ...
        function generatePool() {
            ...
            if (currentLevel === 4) {
                // Chỉ chọn thêm 1 từ ngẫu nhiên để tổng cộng là 2 box
            ...
            // Đảm bảo Level 3 và 4 luôn có đúng 2 phần tử (trường hợp ngẫu nhiên trùng)
            if ((currentLevel === 3 || currentLevel === 4) && unique.length === 1) {
                return generatePool(); // Chạy lại nếu bị trùng ID
            }
...
export const GameVocabularyAdjectives2: React.FC = () => {
        ...
        <div ref={gameWrapperRef} className="relative w-full h-full bg-slate-900">
            {iframeSrc && (
                <iframe
                    ...
                    style={{ border: 'none' }}
                    allow="fullscreen"
                    title="Vietnamese Adjectives 2 Game"
                ></iframe>
            )}
            <button 
