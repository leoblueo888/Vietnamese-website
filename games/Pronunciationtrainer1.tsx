...
const ANALYZE_MODEL = "gemini-2.5-flash-preview-09-2025";
...
export const Pronunciationtrainer1: React.FC = () => {
  ...
  const fetchDefinition = async (word: string) => {
    ...
    try {
      ...
      const prompt = `Check Vietnamese word: "${word}". 
      ...
      const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${ANALYZE_MODEL}:generateContent?key=${process.env.API_KEY}`, {
        method: 'POST',
