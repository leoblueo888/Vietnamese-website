...
console.log('VowelTone Game Loaded');

// The user-provided HTML game code is stored as a template string, adapted for Vowels.
const gameHTML = `
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title>Vietnamese Tones Quest - Vowels</title>
    ...
    <style>
        ...
        body {
            ...
            user-select: none;
            position: relative; /* Essential for absolute overlay containment */
        }
        ...
        #start-overlay {
            position: absolute; /* MODIFIED: was fixed */
            inset: 0;
...
<body class="p-0">
    ...
    <header id="main-header" class="w-full z-[100] h-[30%] flex flex-col items-center justify-center relative border-b border-blue-500/10 hidden">
        <div class="text-center px-4 w-full">
            <h1 class="text-2xl md:text-4xl font-bold neon-text mb-2 md:mb-6 uppercase tracking-widest leading-tight">Listening Quest</h1>
    ...
    <div id="start-overlay">
        <div class="text-center mb-6 md:mb-10 w-full max-w-4xl px-4 flex flex-col items-center">
            <h1 class="text-3xl md:text-5xl font-bold neon-text mb-6 md:mb-8 uppercase tracking-[0.15em] md:tracking-[0.2em] w-full text-center whitespace-nowrap overflow-hidden" data-i18n="title">Dấu Việt</h1>
    ...
    <main id="game-container" class="h-[70%] w-full hidden relative overflow-hidden flex flex-col p-2 md:p-4">
    ...
    <script>
        ...
        window.onload = () => {
             ...
             document.getElementById('lang-vi-start').addEventListener('click', () => setLanguage('vi'));
             document.getElementById('lang-en-start').addEventListener('click', () => setLanguage('en'));
             document.getElementById('lang-ru-start').addEventListener('click', () => setLanguage('ru'));
             document.getElementById('btn-popup-next').addEventListener('click', nextRound);
             document.getElementById('btn-restart-final').addEventListener('click', restartFullGame);
        };
    </script>
</body>
</html>
