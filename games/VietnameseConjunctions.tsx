...
<body>
    ...
    <div id="start-screen" class="overlay" style="display: flex;">
        <div class="text-center animate-pop max-w-4xl w-full px-6 flex flex-col items-center">
            ...
            <p id="start-subtitle" class="text-white/60 mb-8 uppercase tracking-[0.3em] font-bold text-sm">Liên từ Tiếng Việt</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-8 max-w-md mx-auto w-full">
                <button class="mix-btn" onclick="startGame(0)">
                    ...
                    <span id="start-btn-sub" class="font-bold uppercase text-xs tracking-widest opacity-70">LIÊN TỪ</span>
                </button>
            </div>
        </div>
    </div>
    ...
    <main class="flex-grow flex flex-col items-center justify-center relative overflow-hidden p-6">
        <div id="game-canvas" class="z-10 w-full flex justify-center"></div>
        <div id="answer-container" class="z-20 w-full flex justify-center"></div>
    ...
    <script>
        ...
        const rawData = [
            {
                ...
                vocabulary: [
                    ...
                    { vn: "nếu", ph: "If", ru: "ЕСЛИ", practices: [
                        ...
                        { leftVn: "Hãy mua", rightVn: "bạn muốn.", ans: "nếu", fullVn: "Hãy mua nếu bạn muốn.", transEn: "Buy it if you want.", transRu: "Купи, nếu muốn." }
                    ]},
        ...
        function setLanguage(lang) {
            ...
            document.getElementById('start-subtitle').innerText = "Liên từ Tiếng Việt";
            document.getElementById('start-btn-text').innerText = t.start;
            document.getElementById('start-btn-sub').innerText = "LIÊN TỪ";
            document.getElementById('next-round-btn').innerText = t.continue;
            
            rawData[0].name = "LIÊN TỪ";
        }
        ...
        function updateHeaderUI() {
            ...
            document.getElementById('lvl-name').innerText = "LIÊN TỪ";
        ...
        function createFloating(text) {
            ...
            el.onmousedown = (e) => setupDragging(e, el, text);
            el.ontouchstart = (e) => setupDragging(e, el, text);

            move();
        }

        function setupDragging(e, el, text) {
            ...
            let targetEl = el;
            if (el.dataset.source === 'static') {
                targetEl = el.cloneNode(true);
                targetEl.style.position = 'fixed';
                targetEl.style.zIndex = '3000';
                targetEl.classList.add('floating-word');
            ...
            const onMove = (m) => {
                ...
                targetEl.style.left = (mX - offX) + 'px';
                targetEl.style.top = (mY - offY) + 'px';
                
                const dz = document.querySelector('.drop-zone');
                if (dz) {
                    const r1 = dz.getBoundingClientRect();
        ...
        function renderPhase2() {
            ...
            container.innerHTML = \`
                ...
                <div class="text-yellow-400 font-bold uppercase text-sm tracking-widest mt-2">\${t.complete}</div>
            \`;
...
export const VietnameseConjunctions: React.FC = () => {
...
export default VietnameseConjunctions;
